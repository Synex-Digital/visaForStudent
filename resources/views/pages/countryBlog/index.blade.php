    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive custom-scrollbar">
                <table class="table table-dashed table-responsive">
                    <thead>
                        <tr>
                            <th scope="col">Id </th>
                                    ...
                                    <ul class="action">
                                        <li class="edit me-4">
                                            <a href="{{ route('country-blog.show', $country->id) }}">
                                                <img src="{{ asset('assets/svg/eye.svg') }}" style="width: 20px;"></a>
                                        </li>
                                        <li class="delete">
                                            <a href="#" onclick="setDeleteID('{{ $country->id }}')"
                                                data-bs-toggle="modal" data-bs-target="#tooltipmodal">
                                                <img src="{{ asset('assets/svg/trash.svg') }}" style="width: 20px;"></a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
